...
namespace Carubbi.ExtendedWebBrowser
{
  class UnsafeNativeMethods
  {
    ...
    public interface DWebBrowserEvents2
    {
      ...
      void NewWindow3([In, Out, MarshalAs(UnmanagedType.IDispatch)] ref object ppDisp, [In, Out] ref bool Cancel, [In] long dwFlags, [In, MarshalAs(UnmanagedType.BStr)] string bstrUrlContext, [In, MarshalAs(UnmanagedType.BStr)] string bstrUrl);
    }
