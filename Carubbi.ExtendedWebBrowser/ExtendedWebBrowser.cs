...
{
  /// <summary>
  /// Uma versão extendida do componente <see cref="WebBrowser"/>.
  /// </summary>
  public partial class ExtendedWebBrowser : System.Windows.Forms.WebBrowser
  {


      public ExtendedWebBrowser(string name)
      {
          base.Name = name;
      }
    ...
    /// </summary>
    public event StartNewWindowHandler StartNewWindow;
    ...
    public class WebBrowserExtendedEvents : UnsafeNativeMethods.DWebBrowserEvents2
    {
      ...
      public void NewWindow3(ref object ppDisp, ref bool Cancel, long dwFlags, string bstrUrlContext, string bstrUrl)
      {
