    ...
    public class OutlookInteropReceiver : OutlookInteropBase, IMailReceiver
    {
        ...
        public string Address
        {
            get
            {
                ...
                {
                    _address = _myApp.Session.CurrentUser.Address;

                    if (!Carubbi.Utils.Validation.ValidationExtension.IsValidEmail(_address))
                    {
                        _address = GetAddress(_myApp.Session.CurrentUser.AddressEntry);
                    }
                }
                return _address;
            }
            ...
            do
            {
                ...
                foreach (Object it in items)
                {
                    if (it is MailItem)
                    {
                        ...
                        if (Carubbi.Utils.Validation.ValidationExtension.IsValidEmail(GetSenderSMTPAddress(item)))
                        {
                            readMails++;
